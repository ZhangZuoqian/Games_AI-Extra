...
[注意] 命名规则：本模块不自动加 bot_ 前缀，遵循 carpet.md skill 的约定
...
@register_tool(
    description="批量生成多个假人。每个假人可指定不同坐标/维度。常用于农场分工：一个攻击一个捡物一个放方块。[注意] 假人名必须带 bot_ 前缀（遵循 carpet.md skill 命名规则）。",
    parameters={
        "type": "object",
        "properties": {
            "bots": {
...
@register_tool(
    description="批量移除多个假人。[注意] 假人名必须带 bot_ 前缀（遵循 carpet.md skill 命名规则）。",
    parameters={
        "type": "object",
        "properties": {
            "names": {
...
@register_tool(
    description="让多个假人同时执行相同动作。例如一组假人同时 attack 或同时 mine。常用于多人农场协作。[注意] 假人名必须带 bot_ 前缀（遵循 carpet.md skill 命名规则）。",
    parameters={
        "type": "object",
        "properties": {
            "names": {
